      ...
      case 'search':
        return (
          <div className="text-center py-16">
            ...
            <p className="text-gray-600">Advanced search functionality will be available here.</p>
          </div>
        );
      case 'alerts':
        return (
          <div className="text-center py-16">
            ...
            <p className="text-gray-600">Stock alerts and maintenance notifications will be shown here.</p>
          </div>
        );
      case 'history':
        return (
          <div className="text-center py-16">
            ...
            <p className="text-gray-600">Complete maintenance log and history tracking will be available here.</p>
          </div>
        );
      case 'settings':
        return (
